...
def trainData(imageDirectory, saveDirectory, imageSize=(256, 256)):
    ...
    test_directory = r'C:\Users\alaci\OneDrive - Arrow Glass Industries\Documents\Scripts\Test\imgRec\trainingData\doorType\test'
...
imageDirectory = r'C:\Users\alaci\OneDrive - Arrow Glass Industries\Documents\Scripts\Test\imgRec\trainingData\doorType\train'
...
modelDir = r'C:\Users\alaci\OneDrive - Arrow Glass Industries\Documents\Scripts\Test\imgRec\doorTypeModel'

# Train new data
if True:
    model= trainData(imageDirectory, modelDir, imageSize)
else:
    try:
...
test_directory = r'C:\Users\alaci\OneDrive - Arrow Glass Industries\Documents\Scripts\Test\imgRec\trainingData\doorType\test\door'
